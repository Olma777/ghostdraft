...
> **Статус: ранний (v0.1.0).** Готовы каркас (вендоринг общего ядра + dispatcher) и
> команда `pipe` (просмотр без записи на диск). Логика `new` (RAM-диск/vault, shred,
> чистка editor-истории, `--clipboard`) — в следующих паках.
